...
parser.add_argument('--baseframe', action='store_true', help="Whether to compute the base dataframe or skip it. Default is True.")
parser.set_defaults(baseframe=True)
